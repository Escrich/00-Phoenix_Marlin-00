/**
 * Escrich Phoenix 20221110 downstairs
...
//#define BABYSTEP_ALWAYS_AVAILABLE       // Phoenix to be checked, Allow babystepping at all times (not just during movement).
 ...
 */
//#define PTC_PROBE    // Compensate based on probe temperature Phoenix Octopus, probablemente genera warnings al compilar
...
#if AXIS_IS_TMC(E0)
#define E0_CURRENT 600 // (DETAIL @MK3|QUALITY @MK3).*/}M907 E430 ; (SPEED @MK3|DRAFT @MK3).*/}M907 E538 ; // set extruder motor current
#define E0_MICROSTEPS 16
