 ...
 * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 -1 // Debe ser -1 , no cambiar
...
#define CUSTOM_MACHINE_NAME "Escrich Phoenix"
 ...
 *
 */
#define TEMP_SENSOR_0 1 // 5 // Before it was 504 --- Phoenix --------------------------------998 Dummy values return to good ones
...
#define TEMP_SENSOR_BED 1 // Before it was 505 --- Phoenix ----------------------------- 998 Dummy values returned to good ones
...
// Phoenix Autotune PID results real ones, Thermistor changed to #1 ------------- 20221208
#define DEFAULT_Kp 15.8
#define DEFAULT_Ki 0.89
#define DEFAULT_Kd 70.0
// Hacer el ajuste del PID con la temperatura a 240 ºC
#endif
#endif
...
//
// Valores definidos por mi para mi Phoenix  -- Escrich, Real ones ------------- 20221208 Phoenix
#define DEFAULT_bedKp 84.2
#define DEFAULT_bedKi 16.20
#define DEFAULT_bedKd 292.0
// ----------------------------------------  Hacer el ajuste del PID a 80 ºC
...
// Valores para un husillo de ocho milimetros de avance 16 micropasos
// 79.82249512, 79.88339666, 398.4283055, 94.75
// Cambiando a sinfín paso de 2 mm en lugar de 8, pasan los pasos de 400 a 1600
//
// Extrusora Orbiter
...
// 1240, Resultados bastante buenos en PLA
//
// Nominal a 32 micropasos 1380, en estas condiciones:
// 100 % = 1380, 95% = 1311, 90 % = 1242, 87,5 % = 1207,5, 85 % = 1173
// Nominal a 16 micropasos 690, en estas condiciones:
// 100 % = 690, 95% = 655.5, 90 % = 621, 87,5 % = 603.75, 85 % = 586.5
//
// Con 1247 pasos, en PETG, se aprecia falta de material, con 1311 tambien
// Mejor valor 95% con 32 micropasos, (1311) PETG, hay que seguír trabajando en ello
//
// Funciona sin rayas con estos valores 100, 100, 400, 1240
//
// Longitud tubo de Nylon 70.10 mm., para extrusora Orbiter con hotend V6 en Phoenix
//
 ...
 */
// #define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN, // Ojo, con esto tienes que conectar el BLTouch al z endstop pin

// Force the use of the probe for Z-axis homing
#define USE_PROBE_FOR_Z_HOMING // Phoenix Conectado para eliminar el switch
 ...
 */
// #define FIX_MOUNTED_PROBE // in the case of inductive or capacitive sensor
 ...
 */
#define Z_IDLE_HEIGHT 100 // Z_HOME_POS

#define Z_HOMING_HEIGHT 20 // 4      // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
// Be sure to have this much clearance over your Z_MAX_POS to prevent grinding.

#define Z_AFTER_HOMING 40 // 10      // (mm) Height to move to after homing Z
...
#define XY_DIAG_AC 311.1269837
#define XY_DIAG_BD 311.1269837
...
#define XZ_DIAG_AC 311.1269837
#define XZ_DIAG_BD 311.1269837
#define YZ_DIAG_AC 311.1269837
#define YZ_DIAG_BD 311.1269837
 ...
 */
// #define DISPLAY_CHARSET_HD44780 JAPANESE // default
#define DISPLAY_CHARSET_HD44780 WESTERN // Working on Anet
...
//
// #define REPRAP_DISCOUNT_SMART_CONTROLLER // Este no es el correcto para el display TFT24V1
...
// #define TFT_COLOR_UI // Not for TFT24V1
// #define TFT_LVGL_UI
